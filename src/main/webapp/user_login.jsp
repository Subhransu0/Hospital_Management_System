			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						...
						<c:if test="${not empty logoutmssg }">
						<p class="text-center text-success fs-3">${logoutmssg }</p>
						<c:remove var="logoutmssg" scope="session"/>
						</c:if>  
						
						<c:if test="${not empty usereloginerror }">
						<p class="text-center text-danger fs-3">${usereloginerror }</p>
